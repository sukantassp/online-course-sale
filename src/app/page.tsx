...
export default function HomePage() {
  const featuredCourses = mockCourses.slice(0, 5);
  ...
  return (
    <div>
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden">
        ...
        <div className="relative max-w-layout mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
      ...
      {/* Featured Courses */}
      <section className="py-20 bg-background featuredCourses">
        <div className="max-w-layout mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section className="py-20 bg-primary">
        <div className="max-w-layout mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link href="/courses">
              <Button size="lg" variant="outline" className="border-white text-secondary hover:text-secondary">
                Browse Courses
              </Button>
            </Link>
          </div>
